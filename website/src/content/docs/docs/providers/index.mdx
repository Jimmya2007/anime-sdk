---
title: Providers
description: Overview of the 9 live-tested anime and manga providers in ani-sdk.
---

A provider is a site-specific adapter that maps search queries and episode/chapter IDs to direct stream or image URLs. All 9 ship with ani-sdk and are verified on every release.
