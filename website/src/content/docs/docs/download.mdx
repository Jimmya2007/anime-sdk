---
title: Downloads
description: Save anime episodes as MP4 and manga chapters as ZIP archives using ani-sdk's built-in download utilities.
---
...
```ts
import { HttpClient, AllmangaProvider, downloadVideo } from 'ani-sdk';
...
```ts
import { MangadexProvider, HttpClient, downloadMangaPage } from 'ani-sdk';
...
```ts
import { MangadexProvider, HttpClient, downloadMangaChapter } from 'ani-sdk';
