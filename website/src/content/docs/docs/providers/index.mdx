---
title: Providers
description: Overview of the seven live-tested anime and manga providers in ani-sdk.
---

A provider is a site-specific adapter that maps search queries and episode/chapter IDs to direct stream or image URLs. All seven ship with ani-sdk and are verified on every release.
